...
// Note: We don't import specific icons here anymore, as we'll use their names (strings).
...
export const booths: Booth[] = [
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-prism-ai-start to-booth-prism-ai-end',
    iconName: 'Cpu', // Changed from icon: Cpu
    heroImage: 'https://placehold.co/1200x400.png',
    pattern: 'pattern-polka-dots pattern-blue-500 pattern-bg-transparent pattern-opacity-20 pattern-size-4',
    features: [
      { id: 'f1-1', name: 'AI-Powered Analytics', description: 'Gain deep insights from your data with advanced AI analytics.', longDescription: 'Our AI-Powered Analytics platform leverages machine learning algorithms to uncover hidden patterns, predict future trends, and provide actionable intelligence from complex datasets. Visualize your data in new ways and make smarter decisions.', image: 'https://placehold.co/600x400.png' },
      { id: 'f1-2', name: 'Intelligent Automation', description: 'Automate complex workflows using AI.', longDescription: 'Streamline your operations and boost efficiency by automating repetitive tasks and complex processes. Our intelligent automation solutions adapt to changing conditions and learn over time.', image: 'https://placehold.co/600x400.png' },
      { id: 'f1-3', name: 'Personalized Experiences', description: 'Deliver tailored experiences with AI.', longDescription: 'Create highly personalized customer journeys and product recommendations. Our AI algorithms analyze user behavior to deliver relevant content and interactions at scale.', image: 'https://placehold.co/600x400.png' },
    ],
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-non-prism-ai-start to-booth-non-prism-ai-end',
    iconName: 'Lightbulb', // Changed from icon: Lightbulb
    heroImage: 'https://placehold.co/1200x400.png',
    pattern: 'pattern-grid pattern-pink-500 pattern-bg-transparent pattern-opacity-20 pattern-size-4',
    features: [
  ...
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-ai-dev-start to-booth-ai-dev-end',
    iconName: 'Rocket', // Changed from icon: Rocket
    heroImage: 'https://placehold.co/1200x400.png',
    pattern: 'pattern-lines pattern-green-500 pattern-bg-transparent pattern-opacity-20 pattern-size-4',
    features: [
  ...
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-cross-platform-start to-booth-cross-platform-end',
  ...
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-manufacturing-erp-start to-booth-manufacturing-erp-end',
    iconName: 'Factory', // Changed from icon: Factory
    heroImage: 'https://placehold.co/1200x400.png',
    features: [
  ...
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-integration-start via-booth-integration-via to-booth-integration-end',
    iconName: 'GitMerge', // Changed from icon: GitMerge
    heroImage: 'https://placehold.co/1200x400.png',
    features: [
  ...
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-cloud-start to-booth-cloud-end',
    iconName: 'Cloud', // Changed from icon: Cloud
    heroImage: 'https://placehold.co/1200x400.png',
    features: [
  ...
  },
  {
    ...
    colorGradient: 'bg-gradient-to-br from-booth-cloud-enablers-start to-booth-cloud-enablers-end',
    iconName: 'Layers', // Changed from icon: Layers
    heroImage: 'https://placehold.co/1200x400.png',
    features: [
